...
public class QuizService {
    ...
    public Quiz createQuiz(String category, int noOfQuestions, String title) {
        ...
        // questionService.getRandomQuestionsByCategory(category, noOfQuestions);
        // quiz.setTitle(title);
    ...
    public AtomicInteger submitQuiz(List<QuizSubmission> quizSubmission) {
        ...
        // if (option.getOption().equals(submission.studentAnswer()) &&
        // option.getIsCorrect().booleanValue()) {
